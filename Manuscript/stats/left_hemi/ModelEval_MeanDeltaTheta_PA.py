...
for PA LH, which are used in Figure7b_DeltaTheta_ModelvsAverageMap.py.
"""
...
def PA_difference(model):
    ...
    Benson14_predictions = \
        np.load(
            './../../testset_results/benson14/benson14_testPrediction_PA_lh.npz')[
            'list']
    ...
    np.savez('./../output/ErrorPerParticipant_PA_LH_EarlyVisualCortex_' + str(
        model) + '_1-8'
