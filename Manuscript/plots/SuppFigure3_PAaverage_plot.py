...
np.savez(f'./output/AveragePolarAngleMap_{HEMI_FILENAME}H.npz', list=PA)
...
# view.save_as_html(f'D:\\Retinotopy Project\\surf_images\\PA_{HEMI_FILENAME}H_mean_trainset\\empirical_mean_trainset_LH')
